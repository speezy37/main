...
.Login command text box
image::loginTextBox.png[]

.Message that should appear after a successful login command
image::loginSuccessScreenShot.png[width="600"]
====
...
Refer to <<tableOfDefaultContacts>> upon app reset on the contacts available.
