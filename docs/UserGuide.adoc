...
+
.  If the app does not contain any sample data (refer to <<.List of user accounts at first launch or upon
reset, Table 1>>), something went wrong during the download process. Delete the folder `BankAB` and repeat step 1 to 4.
