...
Format: `add n/NAME ic/NRIC pwd/PASSWORD p/PHONE_NUMBER e/EMAIL d/DEPARTMENT a/ADDRESS wr/WORKINGRATE [plvl/PRIORITY_LEVEL] [t/TAG]...`
...
Checked in shows check in date and time. +

image::checkedIn.PNG[width="270"]

Checked out shows hours worked and salary per day according to employees' working rate per hour. +
