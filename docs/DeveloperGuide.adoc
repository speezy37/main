...
.	User enters add command, followed by the details of the new employee.
.	AddressBook adds the new employee.
+
Use case ends.

*Extensions*

* 2a. Employee already exists in the AddressBook.
** 2a1. AddressBook shows employee already exists message.
+
Use case ends.

* 2b. The added employee has missing details.
** 2b1. AddressBook shows an error message.
+
Use case ends.

* 2c. The added employee has wrong entry format.
...
.	User enters delete command, followed by the index of the specific employee
...
* 2a. The given employee name is invalid
