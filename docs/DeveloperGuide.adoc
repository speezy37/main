...
* 1b. The given date is an invalid calendar date.
** 1b1. BankAB shows an error message.
+
Use case ends.

* 1c. The given date has passed.
** 1c1. BankAB shows an error message.
+
Use case ends.

* 1d. The given date is an existing leave application.
** 1d1. BankAB shows an error message.
+
Use case ends.
...
* 1b. Invalid index given.
** 1b1. BankAB shows an error message. +
Use case ends.

* 1c. Not authorized to delete other user's leave application due to insufficient priority level.
** 1c1. BankAB shows an error message.
+
Use case ends.
...
* 1c. Not authorized to approve/reject your own leave application.
** 1c1. BankAB shows an error message.
+
Use case ends.

* 1d. Not authorized to approve/reject other user's leave application due to insufficient priority level.
** 1d1. BankAB shows an error message.
+
Use case ends.

* 1e. The leave application was already been approved/rejected.
** 1e1. BankAB shows an error message.
+
