...
*** Made significant changes to priority level ranking following the feedback received from the practical exam 1: https://github.com/CS2113-AY1819S1-T16-3/main/pull/134[#134]
...
====
include::../UserGuide.adoc[tag=jylee-git]
====
...
====
include::../DeveloperGuide.adoc[tag=jylee-git]
====
