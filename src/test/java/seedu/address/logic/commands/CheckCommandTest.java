...
public class CheckCommandTest {
    ...
    @Test
    public void equals() {
        final CheckCommand standardCommand = new CheckCommand(VALID_NRIC_AMY, VALID_PASSWORD_AMY, new Mode(VALID_MODE_AMY));

        // same values -> returns true
        CheckCommand commandWithSameValues = new CheckCommand(VALID_NRIC_AMY, VALID_PASSWORD_AMY, new Mode(VALID_MODE_AMY));
        ...
        assertFalse(standardCommand.equals(new CheckCommand(VALID_NRIC_BOB, VALID_PASSWORD_AMY, new Mode(VALID_MODE_AMY))));

        // different password -> returns false
        assertFalse(standardCommand.equals(new CheckCommand(VALID_NRIC_AMY, VALID_PASSWORD_BOB, new Mode(VALID_MODE_AMY))));

        // different mode -> returns false
        assertFalse(standardCommand.equals(new CheckCommand(VALID_NRIC_AMY, VALID_PASSWORD_AMY, new Mode(VALID_MODE_BOB))));
    }
}
