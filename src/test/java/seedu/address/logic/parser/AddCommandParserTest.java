...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB
            ...
            + DEPARTMENT_DESC_BOB + ADDRESS_DESC_BOB + WORKINGRATE_DESC_BOB
        ...
        assertParseSuccess(parser, NAME_DESC_BOB
            ...
            + ADDRESS_DESC_BOB + WORKINGRATE_DESC_BOB + TAG_DESC_HUSBAND
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB
            + NRIC_DESC_BOB + PASSWORD_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + DEPARTMENT_DESC_BOB
            + INVALID_ADDRESS_DESC + WORKINGRATE_DESC_BOB + TAG_DESC_HUSBAND
            + TAG_DESC_FRIEND, Address.MESSAGE_ADDRESS_CONSTRAINTS);

        // invalid working rate
        assertParseFailure(parser, NAME_DESC_BOB
            + NRIC_DESC_BOB + PASSWORD_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + DEPARTMENT_DESC_BOB
            + ADDRESS_DESC_BOB + INVALID_WORKINGRATE_DESC + TAG_DESC_HUSBAND
            + TAG_DESC_FRIEND, WorkingRate.MESSAGE_WORKINGRATE_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, NAME_DESC_BOB
            + NRIC_DESC_BOB + PASSWORD_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + DEPARTMENT_DESC_BOB
            + ADDRESS_DESC_BOB + WORKINGRATE_DESC_BOB + INVALID_TAG_DESC
